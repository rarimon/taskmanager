...
const Card = ({key, title, description, date, onEdit, onDelete,status,statusbgcolor }) => {
    return (
        <Fragment>
            <div key={key} className="card shadow-sm rounded-1 p-3 mb-4 " style={{ maxWidth: '550px' }}>
